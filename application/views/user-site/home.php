...
<body class="bg-gray-100 w-full">
  ...
  <main class="w-full h-full py-16">
    <div class="h-screen md:h-96 w-full flex flex-col justify-center items-center gap-8 md:gap-24 md:flex-row py-4 sm:py-8 px-4 sm:px-16 bg-white shadow-lg">
      <div class="md:basis-2/3 flex flex-col gap-4 py-4 px-8 justify-start items-start">
        <h1 class="capitalize text-2xl md:text-5xl  font-bold">Most tasty food for you.</h1>
    ...
    <div class="w-72 mx-auto h-1 bg-red-600 mb-4 mt-4 rounded-tr-full rounded-bl-full"></div>
